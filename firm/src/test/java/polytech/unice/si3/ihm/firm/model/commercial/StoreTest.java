...
public class StoreTest {
    ...
    public void defineContext(){
    	store = new Store("Kebabier du coin", "Dans le coin justement", "Sophia", "00000","Provence-Alpes Cote d'Azur", "PolyCenter", "Du chat de qualitay", "src/main/resources/images/nice_etoile.png");
    }
